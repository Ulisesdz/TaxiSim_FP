...
public class UserManager : MonoBehaviour
{
    ...
    public void CreateUser()
    {
        ...
        if (userInstance != null)
        {
            Debug.Log("Nuevo usuario generado.");
        }
    }
    ...
    private GameObject CreateUserOnSpline()
    {
        ...
        double startPercent = Random.Range(0f, 1f);
        Vector3 userPosition = userSpline.EvaluatePosition(startPercent);
    ...
    public void RemoveUser()
    {
        if (userInstance != null)
        {
            ...
            userInstance = null; // Asegúrate de reiniciar a null después de destruir el objeto
